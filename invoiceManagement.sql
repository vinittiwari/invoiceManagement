...
CREATE TABLE IF NOT EXISTS `invoice` (
  ...
  `transporter_mobile` varchar(50) NOT NULL,
  `transporter_vehicalno` varchar(50) NOT NULL,
...
INSERT INTO `invoice` (`item`, `party_id`, `invoice_date`, `invoice_number`, `dispatch_date`, `address`, `party_name`, `invoice_total`, `transporter_name`, `transporter_mobile`, `transporter_vehicalno`) VALUES
	...
	('[{"item_sgst":"0","item_total_price":"5040","item_id":"GUN57","item_sgst_amount":"0","item_gst":"0","item_cgst":"0","item_name":"Guns","item_total":"6904.8","item_igst_amount":"1612.7999","item_igst":"32","item_gst_amount":"0","item_cess":"5","item_cess_amount":"252.0","item_quantity":"9"}]', 'DA96', '2017-08-15', 27, '2017-08-17', '10~ KhTI WALATA KJASND JKFFI', 'Damodar Sons', 6905, 'Jai Gopala', '986526328465', 'dfasdfsdf'),
	('[{"item_sgst":"0","item_total_price":"4500","item_id":"BOO57","item_sgst_amount":"0","item_gst":"0","item_name":"Books","item_total":"5625.0","item_igst_amount":"900.0","item_igst":"20","item_gst_amount":"0","item_cess":"5","item_cess_amount":"225.0","item_quantity":"9"}]', 'DA96', '2017-08-17', 28, '2017-08-18', '10~ KhTI WALATA KJASND JKFFI', 'Damodar Sons', 5625, 'Jai Gopala', '', '');
...
INSERT INTO `item` (`item_name`, `item_id`, `price`, `item_code`, `rate`, `create_date`, `status`, `unit`, `cess`) VALUES
	...
	('vinit', 'VIN80', 55, 'FGE', '453', '2017-08-18', 'true', 'sfas', '51');
...
INSERT INTO `party` (`party_name`, `address`, `address1`, `state`, `gstin`, `transport`, `phone1`, `phone2`, `email1`, `email2`, `party_id`) VALUES
	('asdgfasdf', '', '', 'Andhra Pradesh', '26SSSSS2365S5S5', '', '989898989898', '', 'asdfasd@sdf.com', '', 'ASD93'),
